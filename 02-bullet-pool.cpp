...
//===========================================================================
/*
  Modified 02-bullet-poll.cpp with new objects and physics by Sergio Aranda Lizano
...
int main(int argc, char* argv[])
{
    ...
    double radius = 0.20;
    double size = 0.4;
   // create three box that are added to the world
    ...
    // create three balls that are added to the world
...
// define some material properties for each cube
    ...
    bulletBox0->setLocalPos(0.0, 1.5, 0.8);
    bulletBox1->setLocalPos(0.0, 1.5, 0.0);
    bulletBox2->setLocalPos(0.0, 1.5, 0.4);
...
///////////////SPHERES///////////////////
    ...
    fileLoad = bulletBall0->m_texture->loadFromFile(RESOURCE_PATH("../resources/images/blackstone.jpg"));
    if (!fileLoad)
    {
        #if defined(_MSVC)
        fileLoad = bulletBall0->m_texture->loadFromFile("../../../bin/resources/images/blackstone.jpg");
        #endif
    }

    bulletBall1->m_texture = cTexture2d::create();
    bulletBall1->setUseTexture(true);
    fileLoad = bulletBall1->m_texture->loadFromFile(RESOURCE_PATH("../resources/images/brownboard.jpg"));
    if (!fileLoad)
    {
        #if defined(_MSVC)
        fileLoad = bulletBall1->m_texture->loadFromFile("../../../bin/resources/images/brownboard.jpg");
        #endif
    }

    bulletBall2->m_texture = cTexture2d::create();
    bulletBall2->setUseTexture(true);
    fileLoad = bulletBall2->m_texture->loadFromFile(RESOURCE_PATH("../resources/images/canvas.jpg"));
    if (!fileLoad)
    {
        #if defined(_MSVC)
        fileLoad = bulletBall2->m_texture->loadFromFile("../../../bin/resources/images/canvas.jpg");
        #endif
    }
    ...
    // define some mass properties for each cube
    bulletBall0->setMass(0.1);
    bulletBall1->setMass(0.05);
    bulletBall2->setMass(0.01);
    ...
    bulletBall0->setLocalPos( 0.6,-0.7,-0.5);
    bulletBall1->setLocalPos( 0.6, 0.7,-0.5);
    bulletBall2->setLocalPos( 0.6, 0.0,-0.5);
